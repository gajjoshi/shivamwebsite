...
export default function Navbar() {
  ...
  return (
    ...
    <div>
      ...
      <nav className="navbar navbar-expand-lg bg-body-tertiary p-0 justify-content-center" style={{ backgroundColor: "#b62e2f" }}>
    ...
    <div className="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
      <div className="navbar-nav mb-4 mb-lg-0">
        ...
        <div style={styles1} onClick={() => { setSelect(1) }}>
          <a className="nav-link active" aria-current="page" href="#"><div style={s1}>Home</div></a>
        </div>
        </Link>
        <Link to="us" smooth={true} duration={300}>
        <div style={styles5} onClick={() => { setSelect(5) }}>
          <a className="nav-link active" aria-current="page" href="#"><div style={s5}>Our Story</div></a>
        </div>
        </Link>
        <Link to="project" smooth={true} duration={300}>
          <div style={styles3} onClick={() => { setSelect(3) }}>
            <a className="nav-link active" href="#"><div style={s3}>Projects</div></a>
          </div>
        </Link>
        <Link to="about" smooth={true} duration={300}>
        <div style={styles2} onClick={() => { setSelect(2) }}>
          <a className="nav-link active" href="#"><div style={s2}>About us</div></a>
        </div>
        </Link>
        ...
        <Link to="contact" smooth={false} duration={500}>
          <div style={styles4} onClick={() => { setSelect(4) }}>
            <a className="nav-link active" href="#"><div style={s4}>Contact us</div></a>
          </div>
        </Link>
      </div>
    </div>
